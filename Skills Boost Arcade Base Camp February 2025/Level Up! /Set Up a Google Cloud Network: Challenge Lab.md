## First Run this command in Cloud Shell
```
export VPC_NETWORK_NAME=
export FIRST_SUBNET=
export SECOND_SUBNET=
export FIREWALL_RULE_1=
export FIREWALL_RULE_2=
export FIREWALL_RULE_3=
export FIRST_ZONE=
export SECOND_ZONE=
```
...
echo "${BG_RED}${BOLD}Subscribe to BOOST THE ARCADE${RESET}"
